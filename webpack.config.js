...
module.exports = {
    ...
    module: {
        rules: [
            {
                test: /\.css$/, // Regex para identificar archivoas css
                use: ['style-loader', 'css-loader'], // Loaders para procesar archivos
            },
            {
                test: /\.js$/, // Regex para identificar archivos JS
                exclude: /node_modules/, // Excluir carpeta modules
                use: {
    ...
    devServer: {
        contentBase: path.resolve(__dirname, 'dist'), // Carpeta desde donde optenemos los archivos para mostrarlos al usuario
